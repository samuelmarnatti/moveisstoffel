...
class Interceptor extends \Magento\Theme\Model\ResourceModel\Design\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'joinStore');
        return $pluginInfo ? $this->___callPlugins('joinStore', func_get_args(), $pluginInfo) : parent::joinStore();
    }
    ...
    public function addDateFilter($date = null)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addDateFilter', func_get_args(), $pluginInfo) : parent::addDateFilter($date);
    }
